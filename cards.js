...
class Cards {
    constructor(cardsDiv) {
        ...
        this.tagDictionary = {};
        this.listButton = document.getElementById('list-button').onclick = this.listButtonPressed;
        this.categoriesButton = document.getElementById('categories-button').onclick = this.eraseAllCards;
    }
